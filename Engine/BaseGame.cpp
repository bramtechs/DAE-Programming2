...
BaseGame::BaseGame(const Window &window)
    : m_Window{window}, m_Viewport{0, 0, window.width, window.height}, m_pWindow{nullptr}, m_pContext{nullptr},
      m_Initialized{false}, m_MaxElapsedSeconds{0.1f}
{
...
void BaseGame::InitializeGameEngine()
{
    ...
    // Create window
    m_pWindow = SDL_CreateWindow(m_Window.title.c_str(), SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED,
                                 int(m_Window.width), int(m_Window.height), SDL_WINDOW_OPENGL);
...
{
    m_ControllerMap = {
        {SDL_CONTROLLER_BUTTON_A, SDL_SCANCODE_SPACE},      {SDL_CONTROLLER_BUTTON_B, SDL_SCANCODE_B},
        {SDL_CONTROLLER_BUTTON_X, SDL_SCANCODE_X},          {SDL_CONTROLLER_BUTTON_Y, SDL_SCANCODE_Y},
        {SDL_CONTROLLER_BUTTON_BACK, SDL_SCANCODE_I},       {SDL_CONTROLLER_BUTTON_DPAD_LEFT, SDL_SCANCODE_A},
        {SDL_CONTROLLER_BUTTON_DPAD_RIGHT, SDL_SCANCODE_D}, {SDL_CONTROLLER_BUTTON_DPAD_UP, SDL_SCANCODE_W},
        {SDL_CONTROLLER_BUTTON_DPAD_DOWN, SDL_SCANCODE_S},  {SDL_CONTROLLER_BUTTON_LEFTSHOULDER, SDL_SCANCODE_O},
        {SDL_CONTROLLER_BUTTON_LEFTSTICK, SDL_SCANCODE_K},  {SDL_CONTROLLER_BUTTON_RIGHTSHOULDER, SDL_SCANCODE_P},
